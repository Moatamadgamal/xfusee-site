    ...
    ({ className, error, ...props }, ref) => {
        return (
            <div className="w-full">
                <textarea
                    className={cn(
                        'flex min-h-[120px] w-full rounded-lg glass border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-transparent px-4 py-3 text-sm text-gray-900 dark:text-white',
