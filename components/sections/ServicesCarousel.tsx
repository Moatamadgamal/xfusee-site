                        ...
                        {currentServices.map((service, index) => {
                            ...
                            return (
                                <SwiperSlide key={`${activeCategory}-${index}`} className="!w-[90%] sm:!w-[500px]">
                                    ...
                                    >
                                        {/* Flip Card Container */}
                                        <div className={`relative w-full h-[600px] transition-transform duration-700 preserve-3d ${isFlipped ? 'rotate-y-180' : ''}`}>

                                            {/* FRONT SIDE */}
                                            <div className="absolute inset-0 backface-hidden">
                                                <div className={`relative overflow-hidden rounded-3xl bg-gradient-to-br ${service.gradient} p-[2px] h-full shadow-2xl`}>
                                                    <div className="relative bg-gray-50 dark:bg-gray-900 backdrop-blur-xl rounded-3xl overflow-hidden h-full">
                                                        {/* Service Image */}
                                                        ...
                                                        <div className="p-6 space-y-4">
                                                            ...
                                                            {/* Title */}
                                                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-400 group-hover:to-purple-400 transition-all">
                                                                {service.title}
                                                            </h3>
                                                            ...
                                                            {/* Testimonial */}
                                                            <div className="p-3 rounded-lg bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 backdrop-blur-sm">
                                            ...
                                            <div className="absolute inset-0 backface-hidden rotate-y-180">
                                                <div className={`relative overflow-hidden rounded-3xl bg-gradient-to-br ${service.gradient} p-[2px] h-full shadow-2xl`}>
                                                    <div className="relative bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-black backdrop-blur-xl rounded-3xl overflow-hidden h-full p-8 flex flex-col justify-center">
                                                        ...
                                                        <div className="relative z-10 space-y-6">
                                                            ...
                                                            <div className="flex items-center gap-4">
                                                                <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${service.gradient} flex items-center justify-center shadow-lg`}>
